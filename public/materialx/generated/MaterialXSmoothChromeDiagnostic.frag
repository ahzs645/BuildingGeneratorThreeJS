...
uniform float SS_smooth_chrome_diagnostic_base;
uniform vec3 SS_smooth_chrome_diagnostic_base_color;
uniform float SS_smooth_chrome_diagnostic_diffuse_roughness;
uniform float SS_smooth_chrome_diagnostic_metalness;
uniform float SS_smooth_chrome_diagnostic_specular;
uniform vec3 SS_smooth_chrome_diagnostic_specular_color;
uniform float SS_smooth_chrome_diagnostic_specular_roughness;
uniform float SS_smooth_chrome_diagnostic_specular_IOR;
uniform float SS_smooth_chrome_diagnostic_specular_anisotropy;
uniform float SS_smooth_chrome_diagnostic_specular_rotation;
uniform float SS_smooth_chrome_diagnostic_transmission;
uniform vec3 SS_smooth_chrome_diagnostic_transmission_color;
uniform float SS_smooth_chrome_diagnostic_transmission_depth;
uniform vec3 SS_smooth_chrome_diagnostic_transmission_scatter;
uniform float SS_smooth_chrome_diagnostic_transmission_scatter_anisotropy;
uniform float SS_smooth_chrome_diagnostic_transmission_dispersion;
uniform float SS_smooth_chrome_diagnostic_transmission_extra_roughness;
uniform float SS_smooth_chrome_diagnostic_subsurface;
uniform vec3 SS_smooth_chrome_diagnostic_subsurface_color;
uniform vec3 SS_smooth_chrome_diagnostic_subsurface_radius;
uniform float SS_smooth_chrome_diagnostic_subsurface_scale;
uniform float SS_smooth_chrome_diagnostic_subsurface_anisotropy;
uniform float SS_smooth_chrome_diagnostic_sheen;
uniform vec3 SS_smooth_chrome_diagnostic_sheen_color;
uniform float SS_smooth_chrome_diagnostic_sheen_roughness;
uniform float SS_smooth_chrome_diagnostic_coat;
uniform vec3 SS_smooth_chrome_diagnostic_coat_color;
uniform float SS_smooth_chrome_diagnostic_coat_roughness;
uniform float SS_smooth_chrome_diagnostic_coat_anisotropy;
uniform float SS_smooth_chrome_diagnostic_coat_rotation;
uniform float SS_smooth_chrome_diagnostic_coat_IOR;
uniform float SS_smooth_chrome_diagnostic_coat_affect_color;
uniform float SS_smooth_chrome_diagnostic_coat_affect_roughness;
uniform float SS_smooth_chrome_diagnostic_thin_film_thickness;
uniform float SS_smooth_chrome_diagnostic_thin_film_IOR;
uniform float SS_smooth_chrome_diagnostic_emission;
uniform vec3 SS_smooth_chrome_diagnostic_emission_color;
uniform vec3 SS_smooth_chrome_diagnostic_opacity;
uniform bool SS_smooth_chrome_diagnostic_thin_walled;
...
void main()
{
    ...
    surfaceshader SS_smooth_chrome_diagnostic_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_optim(SS_smooth_chrome_diagnostic_base, SS_smooth_chrome_diagnostic_base_color, SS_smooth_chrome_diagnostic_diffuse_roughness, SS_smooth_chrome_diagnostic_metalness, SS_smooth_chrome_diagnostic_specular, SS_smooth_chrome_diagnostic_specular_color, SS_smooth_chrome_diagnostic_specular_roughness, SS_smooth_chrome_diagnostic_specular_IOR, SS_smooth_chrome_diagnostic_specular_anisotropy, SS_smooth_chrome_diagnostic_specular_rotation, SS_smooth_chrome_diagnostic_transmission, SS_smooth_chrome_diagnostic_transmission_color, SS_smooth_chrome_diagnostic_transmission_depth, SS_smooth_chrome_diagnostic_transmission_scatter, SS_smooth_chrome_diagnostic_transmission_scatter_anisotropy, SS_smooth_chrome_diagnostic_transmission_dispersion, SS_smooth_chrome_diagnostic_transmission_extra_roughness, SS_smooth_chrome_diagnostic_subsurface, SS_smooth_chrome_diagnostic_subsurface_color, SS_smooth_chrome_diagnostic_subsurface_radius, SS_smooth_chrome_diagnostic_subsurface_scale, SS_smooth_chrome_diagnostic_subsurface_anisotropy, SS_smooth_chrome_diagnostic_sheen, SS_smooth_chrome_diagnostic_sheen_color, SS_smooth_chrome_diagnostic_sheen_roughness, SS_smooth_chrome_diagnostic_coat, SS_smooth_chrome_diagnostic_coat_color, SS_smooth_chrome_diagnostic_coat_roughness, SS_smooth_chrome_diagnostic_coat_anisotropy, SS_smooth_chrome_diagnostic_coat_rotation, SS_smooth_chrome_diagnostic_coat_IOR, geomprop_Nworld_out1, SS_smooth_chrome_diagnostic_coat_affect_color, SS_smooth_chrome_diagnostic_coat_affect_roughness, SS_smooth_chrome_diagnostic_thin_film_thickness, SS_smooth_chrome_diagnostic_thin_film_IOR, SS_smooth_chrome_diagnostic_emission, SS_smooth_chrome_diagnostic_emission_color, SS_smooth_chrome_diagnostic_opacity, SS_smooth_chrome_diagnostic_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SS_smooth_chrome_diagnostic_out);
    material MaterialXSmoothChromeDiagnostic_out = SS_smooth_chrome_diagnostic_out;
    out1 = vec4(mx_srgb_encode(MaterialXSmoothChromeDiagnostic_out.color), 1.0);
}
