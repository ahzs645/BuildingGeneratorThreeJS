...
uniform float SS_catalog_chrome_grill_base;
uniform vec3 SS_catalog_chrome_grill_base_color;
uniform float SS_catalog_chrome_grill_diffuse_roughness;
uniform float SS_catalog_chrome_grill_metalness;
uniform float SS_catalog_chrome_grill_specular;
uniform vec3 SS_catalog_chrome_grill_specular_color;
uniform float SS_catalog_chrome_grill_specular_roughness;
uniform float SS_catalog_chrome_grill_specular_IOR;
uniform float SS_catalog_chrome_grill_specular_anisotropy;
uniform float SS_catalog_chrome_grill_specular_rotation;
uniform float SS_catalog_chrome_grill_transmission;
uniform vec3 SS_catalog_chrome_grill_transmission_color;
uniform float SS_catalog_chrome_grill_transmission_depth;
uniform vec3 SS_catalog_chrome_grill_transmission_scatter;
uniform float SS_catalog_chrome_grill_transmission_scatter_anisotropy;
uniform float SS_catalog_chrome_grill_transmission_dispersion;
uniform float SS_catalog_chrome_grill_transmission_extra_roughness;
uniform float SS_catalog_chrome_grill_subsurface;
uniform vec3 SS_catalog_chrome_grill_subsurface_color;
uniform vec3 SS_catalog_chrome_grill_subsurface_radius;
uniform float SS_catalog_chrome_grill_subsurface_scale;
uniform float SS_catalog_chrome_grill_subsurface_anisotropy;
uniform float SS_catalog_chrome_grill_sheen;
uniform vec3 SS_catalog_chrome_grill_sheen_color;
uniform float SS_catalog_chrome_grill_sheen_roughness;
uniform float SS_catalog_chrome_grill_coat;
uniform vec3 SS_catalog_chrome_grill_coat_color;
uniform float SS_catalog_chrome_grill_coat_roughness;
uniform float SS_catalog_chrome_grill_coat_anisotropy;
uniform float SS_catalog_chrome_grill_coat_rotation;
uniform float SS_catalog_chrome_grill_coat_IOR;
uniform float SS_catalog_chrome_grill_coat_affect_color;
uniform float SS_catalog_chrome_grill_coat_affect_roughness;
uniform float SS_catalog_chrome_grill_thin_film_thickness;
uniform float SS_catalog_chrome_grill_thin_film_IOR;
uniform float SS_catalog_chrome_grill_emission;
uniform vec3 SS_catalog_chrome_grill_emission_color;
uniform vec3 SS_catalog_chrome_grill_opacity;
uniform bool SS_catalog_chrome_grill_thin_walled;
...
void main()
{
    ...
    surfaceshader SS_catalog_chrome_grill_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_optim(SS_catalog_chrome_grill_base, SS_catalog_chrome_grill_base_color, SS_catalog_chrome_grill_diffuse_roughness, SS_catalog_chrome_grill_metalness, SS_catalog_chrome_grill_specular, SS_catalog_chrome_grill_specular_color, SS_catalog_chrome_grill_specular_roughness, SS_catalog_chrome_grill_specular_IOR, SS_catalog_chrome_grill_specular_anisotropy, SS_catalog_chrome_grill_specular_rotation, SS_catalog_chrome_grill_transmission, SS_catalog_chrome_grill_transmission_color, SS_catalog_chrome_grill_transmission_depth, SS_catalog_chrome_grill_transmission_scatter, SS_catalog_chrome_grill_transmission_scatter_anisotropy, SS_catalog_chrome_grill_transmission_dispersion, SS_catalog_chrome_grill_transmission_extra_roughness, SS_catalog_chrome_grill_subsurface, SS_catalog_chrome_grill_subsurface_color, SS_catalog_chrome_grill_subsurface_radius, SS_catalog_chrome_grill_subsurface_scale, SS_catalog_chrome_grill_subsurface_anisotropy, SS_catalog_chrome_grill_sheen, SS_catalog_chrome_grill_sheen_color, SS_catalog_chrome_grill_sheen_roughness, SS_catalog_chrome_grill_coat, SS_catalog_chrome_grill_coat_color, SS_catalog_chrome_grill_coat_roughness, SS_catalog_chrome_grill_coat_anisotropy, SS_catalog_chrome_grill_coat_rotation, SS_catalog_chrome_grill_coat_IOR, geomprop_Nworld_out1, SS_catalog_chrome_grill_coat_affect_color, SS_catalog_chrome_grill_coat_affect_roughness, SS_catalog_chrome_grill_thin_film_thickness, SS_catalog_chrome_grill_thin_film_IOR, SS_catalog_chrome_grill_emission, SS_catalog_chrome_grill_emission_color, SS_catalog_chrome_grill_opacity, SS_catalog_chrome_grill_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SS_catalog_chrome_grill_out);
    material CatalogChromeGrill_out = SS_catalog_chrome_grill_out;
    out1 = vec4(mx_srgb_encode(CatalogChromeGrill_out.color), 1.0);
}
