...
uniform float perceptual_roughness_in2;
uniform float SS_catalog_chrome_002_base;
uniform vec3 SS_catalog_chrome_002_base_color;
uniform float SS_catalog_chrome_002_diffuse_roughness;
uniform float SS_catalog_chrome_002_metalness;
uniform float SS_catalog_chrome_002_specular;
uniform vec3 SS_catalog_chrome_002_specular_color;
uniform float SS_catalog_chrome_002_specular_IOR;
uniform float SS_catalog_chrome_002_specular_anisotropy;
uniform float SS_catalog_chrome_002_specular_rotation;
uniform float SS_catalog_chrome_002_transmission;
uniform vec3 SS_catalog_chrome_002_transmission_color;
uniform float SS_catalog_chrome_002_transmission_depth;
uniform vec3 SS_catalog_chrome_002_transmission_scatter;
uniform float SS_catalog_chrome_002_transmission_scatter_anisotropy;
uniform float SS_catalog_chrome_002_transmission_dispersion;
uniform float SS_catalog_chrome_002_transmission_extra_roughness;
uniform float SS_catalog_chrome_002_subsurface;
uniform vec3 SS_catalog_chrome_002_subsurface_color;
uniform vec3 SS_catalog_chrome_002_subsurface_radius;
uniform float SS_catalog_chrome_002_subsurface_scale;
uniform float SS_catalog_chrome_002_subsurface_anisotropy;
uniform float SS_catalog_chrome_002_sheen;
uniform vec3 SS_catalog_chrome_002_sheen_color;
uniform float SS_catalog_chrome_002_sheen_roughness;
uniform float SS_catalog_chrome_002_coat;
uniform vec3 SS_catalog_chrome_002_coat_color;
uniform float SS_catalog_chrome_002_coat_roughness;
uniform float SS_catalog_chrome_002_coat_anisotropy;
uniform float SS_catalog_chrome_002_coat_rotation;
uniform float SS_catalog_chrome_002_coat_IOR;
uniform float SS_catalog_chrome_002_coat_affect_color;
uniform float SS_catalog_chrome_002_coat_affect_roughness;
uniform float SS_catalog_chrome_002_thin_film_thickness;
uniform float SS_catalog_chrome_002_thin_film_IOR;
uniform float SS_catalog_chrome_002_emission;
uniform vec3 SS_catalog_chrome_002_emission_color;
uniform vec3 SS_catalog_chrome_002_opacity;
uniform bool SS_catalog_chrome_002_thin_walled;
...
void main()
{
    ...
    float perceptual_roughness_out = rough_property_out * perceptual_roughness_in2;
    surfaceshader SS_catalog_chrome_002_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_optim(SS_catalog_chrome_002_base, SS_catalog_chrome_002_base_color, SS_catalog_chrome_002_diffuse_roughness, SS_catalog_chrome_002_metalness, SS_catalog_chrome_002_specular, SS_catalog_chrome_002_specular_color, perceptual_roughness_out, SS_catalog_chrome_002_specular_IOR, SS_catalog_chrome_002_specular_anisotropy, SS_catalog_chrome_002_specular_rotation, SS_catalog_chrome_002_transmission, SS_catalog_chrome_002_transmission_color, SS_catalog_chrome_002_transmission_depth, SS_catalog_chrome_002_transmission_scatter, SS_catalog_chrome_002_transmission_scatter_anisotropy, SS_catalog_chrome_002_transmission_dispersion, SS_catalog_chrome_002_transmission_extra_roughness, SS_catalog_chrome_002_subsurface, SS_catalog_chrome_002_subsurface_color, SS_catalog_chrome_002_subsurface_radius, SS_catalog_chrome_002_subsurface_scale, SS_catalog_chrome_002_subsurface_anisotropy, SS_catalog_chrome_002_sheen, SS_catalog_chrome_002_sheen_color, SS_catalog_chrome_002_sheen_roughness, SS_catalog_chrome_002_coat, SS_catalog_chrome_002_coat_color, SS_catalog_chrome_002_coat_roughness, SS_catalog_chrome_002_coat_anisotropy, SS_catalog_chrome_002_coat_rotation, SS_catalog_chrome_002_coat_IOR, geomprop_Nworld_out1, SS_catalog_chrome_002_coat_affect_color, SS_catalog_chrome_002_coat_affect_roughness, SS_catalog_chrome_002_thin_film_thickness, SS_catalog_chrome_002_thin_film_IOR, SS_catalog_chrome_002_emission, SS_catalog_chrome_002_emission_color, SS_catalog_chrome_002_opacity, SS_catalog_chrome_002_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SS_catalog_chrome_002_out);
    material CatalogChrome002RoughAttribute_out = SS_catalog_chrome_002_out;
    out1 = vec4(mx_srgb_encode(CatalogChrome002RoughAttribute_out.color), 1.0);
}
