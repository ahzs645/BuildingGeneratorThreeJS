...
uniform float SS_geomprop_color_diagnostic_base;
uniform float SS_geomprop_color_diagnostic_diffuse_roughness;
uniform float SS_geomprop_color_diagnostic_metalness;
uniform float SS_geomprop_color_diagnostic_specular;
uniform vec3 SS_geomprop_color_diagnostic_specular_color;
uniform float SS_geomprop_color_diagnostic_specular_roughness;
uniform float SS_geomprop_color_diagnostic_specular_IOR;
uniform float SS_geomprop_color_diagnostic_specular_anisotropy;
uniform float SS_geomprop_color_diagnostic_specular_rotation;
uniform float SS_geomprop_color_diagnostic_transmission;
uniform vec3 SS_geomprop_color_diagnostic_transmission_color;
uniform float SS_geomprop_color_diagnostic_transmission_depth;
uniform vec3 SS_geomprop_color_diagnostic_transmission_scatter;
uniform float SS_geomprop_color_diagnostic_transmission_scatter_anisotropy;
uniform float SS_geomprop_color_diagnostic_transmission_dispersion;
uniform float SS_geomprop_color_diagnostic_transmission_extra_roughness;
uniform float SS_geomprop_color_diagnostic_subsurface;
uniform vec3 SS_geomprop_color_diagnostic_subsurface_color;
uniform vec3 SS_geomprop_color_diagnostic_subsurface_radius;
uniform float SS_geomprop_color_diagnostic_subsurface_scale;
uniform float SS_geomprop_color_diagnostic_subsurface_anisotropy;
uniform float SS_geomprop_color_diagnostic_sheen;
uniform vec3 SS_geomprop_color_diagnostic_sheen_color;
uniform float SS_geomprop_color_diagnostic_sheen_roughness;
uniform float SS_geomprop_color_diagnostic_coat;
uniform vec3 SS_geomprop_color_diagnostic_coat_color;
uniform float SS_geomprop_color_diagnostic_coat_roughness;
uniform float SS_geomprop_color_diagnostic_coat_anisotropy;
uniform float SS_geomprop_color_diagnostic_coat_rotation;
uniform float SS_geomprop_color_diagnostic_coat_IOR;
uniform float SS_geomprop_color_diagnostic_coat_affect_color;
uniform float SS_geomprop_color_diagnostic_coat_affect_roughness;
uniform float SS_geomprop_color_diagnostic_thin_film_thickness;
uniform float SS_geomprop_color_diagnostic_thin_film_IOR;
uniform float SS_geomprop_color_diagnostic_emission;
uniform vec3 SS_geomprop_color_diagnostic_emission_color;
uniform vec3 SS_geomprop_color_diagnostic_opacity;
uniform bool SS_geomprop_color_diagnostic_thin_walled;
...
void main()
{
    ...
    vec3 color_property_out = i_geomprop_col;
    surfaceshader SS_geomprop_color_diagnostic_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_optim(SS_geomprop_color_diagnostic_base, color_property_out, SS_geomprop_color_diagnostic_diffuse_roughness, SS_geomprop_color_diagnostic_metalness, SS_geomprop_color_diagnostic_specular, SS_geomprop_color_diagnostic_specular_color, SS_geomprop_color_diagnostic_specular_roughness, SS_geomprop_color_diagnostic_specular_IOR, SS_geomprop_color_diagnostic_specular_anisotropy, SS_geomprop_color_diagnostic_specular_rotation, SS_geomprop_color_diagnostic_transmission, SS_geomprop_color_diagnostic_transmission_color, SS_geomprop_color_diagnostic_transmission_depth, SS_geomprop_color_diagnostic_transmission_scatter, SS_geomprop_color_diagnostic_transmission_scatter_anisotropy, SS_geomprop_color_diagnostic_transmission_dispersion, SS_geomprop_color_diagnostic_transmission_extra_roughness, SS_geomprop_color_diagnostic_subsurface, SS_geomprop_color_diagnostic_subsurface_color, SS_geomprop_color_diagnostic_subsurface_radius, SS_geomprop_color_diagnostic_subsurface_scale, SS_geomprop_color_diagnostic_subsurface_anisotropy, SS_geomprop_color_diagnostic_sheen, SS_geomprop_color_diagnostic_sheen_color, SS_geomprop_color_diagnostic_sheen_roughness, SS_geomprop_color_diagnostic_coat, SS_geomprop_color_diagnostic_coat_color, SS_geomprop_color_diagnostic_coat_roughness, SS_geomprop_color_diagnostic_coat_anisotropy, SS_geomprop_color_diagnostic_coat_rotation, SS_geomprop_color_diagnostic_coat_IOR, geomprop_Nworld_out1, SS_geomprop_color_diagnostic_coat_affect_color, SS_geomprop_color_diagnostic_coat_affect_roughness, SS_geomprop_color_diagnostic_thin_film_thickness, SS_geomprop_color_diagnostic_thin_film_IOR, SS_geomprop_color_diagnostic_emission, SS_geomprop_color_diagnostic_emission_color, SS_geomprop_color_diagnostic_opacity, SS_geomprop_color_diagnostic_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SS_geomprop_color_diagnostic_out);
    material MaterialXGeompropColorDiagnostic_out = SS_geomprop_color_diagnostic_out;
    out1 = vec4(mx_srgb_encode(MaterialXGeompropColorDiagnostic_out.color), 1.0);
}
