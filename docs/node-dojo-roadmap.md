...
1. **Chrome Asset Library** — 43 active objects, 26 modifier roots, 404 groups. Four root families are complete; continue in increasing reachable-node complexity.
