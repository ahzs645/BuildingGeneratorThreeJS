...
- Chrome Asset Library: UI Window Generator — nested Object Info dependencies, relative transforms, boundary-only Mesh to Curve selection, vector-to-scalar socket conversion, and the recovered Pixels Medium glyph outlines run in-browser. The portable dump embeds Blender-extracted outlines and vertical metrics without shipping the TTF; authored GN-VM topology is 35,766 / 33,347 versus Blender's 35,886 / 33,474.
