...
Audit date: 2026-07-24. Source: `public/dojo/n03d/root-audit.json`.

The N03D file has 39 active Geometry Nodes roots, but they are not 39 separate
products. Twenty-eight roots are published or intentionally represented in the
101-entry browser library. Five are saved duplicates or equivalent
source-geometry variants, and six are empty/placeholder/stacked helpers. Every
distinct active product root is now represented.
