...
export default function TypewriterPage(): React.JSX.Element {
  ...
  return <main className="typewriter-shell">
    ...
    <aside className="typewriter-panel">
      ...
      <p className="typewriter-note">The supplied Blender file references a missing <code>Blurmed.ttf</code>. This page uses the VM's portable vector-glyph fallback while preserving the authored Slice String, timing, wrapping, spacing, and Fill Curve graph.</p>
    </aside>
