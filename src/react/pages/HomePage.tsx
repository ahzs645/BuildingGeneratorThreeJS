...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Chrome Assets · Blender ↔ Web", title: "Chrome Asset Library", badge: "11 roots", copy: "Isolated Blender reference renders beside live GN-VM output. Eleven root families now run with authored controls and measured Blender parity.", action: "Compare assets" },
