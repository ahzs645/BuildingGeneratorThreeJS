...
const cards = [
  ...
  { href: "/periodic-brush", tag: "Chrome Assets · Live", title: "Periodic Brush", badge: "parity", copy: "The 13-node Chrome Asset Library brush, including its nine-object period pack, with Blender-matched spacing and dot scale controls.", action: "Open brush" },
