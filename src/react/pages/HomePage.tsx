...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Chrome Assets · Blender ↔ Web", title: "Chrome Asset Library", badge: "4 roots", copy: "Isolated Blender reference renders beside live GN-VM output. Four root families now match their authored Blender geometry exactly.", action: "Compare assets" },
