...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "101 assets", copy: "Isolated Blender reference renders beside live GN-VM output. One hundred and one extracted Chrome, N03D, New Joint, Math Clay, course, Nodes Node, and Hat assets now run with measured geometry parity; shader coverage varies by asset.", action: "Compare assets" },
