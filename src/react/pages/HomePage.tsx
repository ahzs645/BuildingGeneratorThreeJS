...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "66 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Sixty-six extracted Chrome, N03D, New Joint, and Math Clay assets now run with authored controls and measured Blender parity.", action: "Compare assets" },
