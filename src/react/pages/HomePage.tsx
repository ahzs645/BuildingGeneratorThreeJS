...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Chrome Assets · Blender ↔ Web", title: "Chrome Asset Library", badge: "6 roots", copy: "Isolated Blender reference renders beside live GN-VM output. Six root families now match their authored Blender geometry and controls.", action: "Compare assets" },
