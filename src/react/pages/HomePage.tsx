...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "78 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Seventy-eight extracted Chrome, N03D, New Joint, Math Clay, and The Nodes Node assets now run with measured Blender parity.", action: "Compare assets" },
