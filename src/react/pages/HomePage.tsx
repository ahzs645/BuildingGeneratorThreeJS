...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "87 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Eighty-seven extracted Chrome, N03D, New Joint, Math Clay, The Nodes Node, and Send Nodes Hat assets now run with measured Blender parity.", action: "Compare assets" },
