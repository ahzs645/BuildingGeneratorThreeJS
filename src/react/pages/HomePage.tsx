...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Chrome Assets · Blender ↔ Web", title: "Chrome Asset Library", badge: "8 roots", copy: "Isolated Blender reference renders beside live GN-VM output. Eight root families now match their authored Blender geometry and controls.", action: "Compare assets" },
