...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Chrome Assets · Blender ↔ Web", title: "Chrome Asset Library", badge: "26 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Twenty-six extracted assets now run with authored controls and measured Blender parity.", action: "Compare assets" },
