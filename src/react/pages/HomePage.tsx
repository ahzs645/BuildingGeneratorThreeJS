...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "49 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Forty-nine extracted Chrome, N03D, and New Joint assets now run with authored controls and measured Blender parity.", action: "Compare assets" },
