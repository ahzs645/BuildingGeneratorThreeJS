...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Chrome Assets · Blender ↔ Web", title: "Chrome Asset Library", badge: "2 ported", copy: "Isolated Blender reference renders beside live GN-VM output. Periodic Brush and Flat Stickie Pack currently match their authored geometry exactly.", action: "Compare assets" },
