...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "37 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Thirty-seven extracted Chrome and N03D assets now run with authored controls and measured Blender parity.", action: "Compare assets" },
