...
const cards = [
  ...
  { href: "/chrome-assets", tag: "Node Dojo Assets · Blender ↔ Web", title: "Live Asset Library", badge: "50 assets", copy: "Isolated Blender reference renders beside live GN-VM output. Fifty extracted Chrome, N03D, and New Joint assets now run with authored controls and measured Blender parity.", action: "Compare assets" },
