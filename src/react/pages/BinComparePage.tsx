    ...
    <div className="bin-compare-shell">
      ...
      <aside className="compare-panel">
        ...
        <section>
          ...
          <div className="segmented secondary"><button id="style-wire" className="active" type="button">Edges</button><button id="style-material" type="button">Shared WebGL preview</button></div>
          <p className="bin-shader-status">Both meshes use the same WebGL reconstruction of the authored Principled constants and Wave/Noise bump. The AnkerMake image remains a labeled fallback; this is not a Blender shader comparison.</p>
