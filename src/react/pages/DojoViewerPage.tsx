...
export default function DojoViewerPage(): React.JSX.Element {
  ...
  return <main className="dojo-viewer-page"><canvas id="app"></canvas><div id="hud"><b>NODE DOJO → WEB</b> · dojo bin generator (baked from .blend) · drag to orbit · scroll to zoom</div><div id="err"></div></main>;
}
