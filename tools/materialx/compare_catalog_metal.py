...
CASES = {
    ...
    "soft-pixel-marker": {
        "label": "Soft Pixel Marker",
        "object": "PIXEL CRAYON.004",
        "material": "chrome.002",
        "geometry": {"vertices": 8_455, "faces": 5_664},
        "blender": "public/dojo/references/chrome-assets/soft-pixel-marker-authored.png",
        "web": "docs/materialx-evidence/current/catalog-metal-soft-pixel-marker-web.png",
        "output": "docs/materialx-evidence/current/catalog-metal-soft-pixel-marker-comparison.json",
    },
    "type-pixel-brush": {
        "label": "Type Pixel Brush Chrome",
        "object": "Type Pixel Brush Chrome",
        "material": "chrome.002",
        "geometry": {"vertices": 17_860, "faces": 11_296},
        "blender": "public/dojo/references/chrome-assets/type-pixel-brush-authored.png",
        "web": "docs/materialx-evidence/current/catalog-metal-type-pixel-brush-web.png",
        "output": "docs/materialx-evidence/current/catalog-metal-type-pixel-brush-comparison.json",
    },
    "blunt-metal-marker": {
        "label": "Blunt Metal Marker",
        "object": "Chrome Marker Extruded",
        "material": "chrome.002",
        "geometry": {"vertices": 97_691, "faces": 97_669},
        "blender": "public/dojo/references/chrome-assets/blunt-metal-marker-authored.png",
        "web": "docs/materialx-evidence/current/catalog-metal-blunt-metal-marker-web.png",
        "output": "docs/materialx-evidence/current/catalog-metal-blunt-metal-marker-comparison.json",
    },
    "text-soup": {
        "label": "Text Soup",
        "object": "TEXT SOUP",
